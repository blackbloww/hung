...
<head>
    ...
    <title>Đĩa Phúc Hoa Mẫu Đơn - 580k</title>
...
<body>
        ...
        <div class="sec-content__slder">
            ...
            <div class="swiper main-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="./assets/images/images-1.jpg" alt=""></div>
                    <div class="swiper-slide"><img src="./assets/images/images-2.jpg" alt=""></div>
                    <div class="swiper-slide"><img src="./assets/images/images-3.jpg" alt=""></div>
                    <div class="swiper-slide"><img src="./assets/images/images-4.jpg" alt=""></div>
                    <div class="swiper-slide"><img src="./assets/images/images-5.jpg" alt=""></div>
                    <div class="swiper-slide"><img src="./assets/images/images-6.jpg" alt=""></div>
                    <div class="swiper-slide"><img src="./assets/images/images-7.jpg" alt=""></div>
                    <div class="swiper-slide"><img src="./assets/images/images-8.jpg" alt=""></div>
    ...
    <main class="main">
        ...
        <section class="sec-banner mt-8">
            <div class="container">
                <p class="noto !text-[2.8rem] font-bold text-center">Đĩa Phúc Hoa Mẫu Đơn</p>
                <p class="philo !text-[2.8rem] font-bold text-center leading-snug !mt-2">Chất Liệu : Sa Thạch<br>Vân Gỗ
                    Tạo Tác Thủ công</p>
                <div class="flex items-center gap-8">
                    <img src="./assets/images/sale.webp" alt="" class="w-[16rem] h-[16rem] flash ">
                    <p class="text-[1.8rem] italic">Giá chỉ từ<br><span
                            class="text-[#cc1818] tino text-[4.5rem] leading-none font-bold zoom-small v2 block">580.000đ</span>
                    </p>
                </div>
        ...
        <section class="sec-introduce mt-8 pb-8">
            <p class="text-[1.9rem] text-white philo text-center py-4">Một mình xé trận cuồng xoay,<br>Thân ngà dựng
                thẳng — Gan dày chống Thiên.</p>
            <div class="mt-2">
                <img src="./assets/images/images-1.jpg" alt="" class="">
            </div>

            <p class="text-[1.9rem] text-[#ffc107] italic text-center pt-6">Huyền Thoại Chiến Mã Đỉnh Phong</p>
            <p class="text-[1.7rem] text-white philo text-center px-2 pb-5 leading-snug !mt-3">Giữa sa mạc gió dữ, chỉ
                có một con ngựa dám lao lên<br>vách đá. Nó không nhanh nhất, không mạnh nhất – nhưng là kẻ duy nhất
                không bỏ cuộc</p>
            <div class="mt-2">
                <img src="./assets/images/images-2.jpg" alt="" class="">
            </div>

            <p class="text-[1.8rem] text-white philo text-center pt-6 pb-4 px-2">Khi nó chạm móng lên tảng đá cuối cùng,
                gió đổi hướng – trời sáng. Bầy đàn phía dưới nhìn theo và gọi nó là Đĩa Phúc Hoa Mẫu Đơn</p>
            <div class="mt-2">
                <img src="./assets/images/images-3.jpg" alt="" class="">
            </div>

            <div class="container bg-white rounded-[2rem] content p-6 !mt-12">
                <span
                    class="text-[#fb0101] barlow font-bold text-[2.2rem] mx-auto w-fit block !border-b-2 leading-[1.1]">THÔNG
                    TIN SẢN PHẨM</span>
                <div class="flex items-center gap-4 mt-6">
                    <img src="./assets/images/icon.png" alt="" class="-mt-2">
                    <p class="text-[1.8rem] leading-[1.2]"><span class="font-bold">Chất liệu:</span> Sa Thạch - Vân Gỗ
                        Vẽ Tay</p>
                </div>
                <div class="flex items-center gap-4 mt-2">
                    <img src="./assets/images/icon.png" alt="" class="-mt-2">
                    <p class="text-[1.8rem] leading-[1.2]"><span class="font-bold">Trọng lượng:</span> 3kg/ bộ</p>
                </div>
                <div class="flex items-center gap-4 mt-2">
                    <img src="./assets/images/icon.png" alt="" class="-mt-2">
                    <p class="text-[1.8rem] leading-[1.2]"><span class="font-bold">Kích thước:</span> 38 x 23 x 12 (cm)
                    </p>
                </div>
                <div class="flex items-start gap-4 mt-2">
                    <img src="./assets/images/icon.png" alt="" class="">
                    <p class="text-[1.8rem] leading-[1.2]"><span class="font-bold">Nơi để phù hợp:</span> Phòng khách,
                        Ban Thần Tài, Quầy thu ngân...</p>
                </div>
                <div class="flex justify-center mt-4">
            ...
            <div class="mt-8">
                <img src="./assets/images/images-4.jpg" alt="" class="">
            </div>

            <p class="text-[1.9rem] text-[#ffc107] italic text-center pt-6">Khai thông vận khí – Chiêu tài đón lộc</p>
            <p class="text-[1.8rem] text-white philo text-center px-2 pb-5 leading-snug !mt-3"> Nhất Mã tung vó đem tới
                dòng khí<br>vượng hỏa, kích hoạt quyết tâm, bản<br>lĩnh và may mắn cho gia chủ.</p>
            <div class="mt-2">
                <img src="./assets/images/images-5.jpg" alt="" class="">
            </div>

            <p class="text-white philo text-center pt-6 pb-4 px-2">Hướng tượng chếch về cửa chính hoặc hướng tài vị để
                đón tài khí, nhưng thân tượng nên quay hơi vào trong nhà hàm ý chở lộc về cho chủ nhân.</p>

        </section>

        <section class="sec-comments pt-8 pb-16">
            <div class="container">
                <div class="flex items-center justify-between roboto">
                ...
                <div class="flex gap-5 mt-12">
                    <img src="./assets/images/avt-6.webp" alt=""
                        class="w-[6.5rem] h-[6.5rem] rounded-full object-cover">
                    <div class="flex flex-col gap-2 flex-1">
                        <p class="mon text-[rgba(5,34,74,1)] font-bold">Mai Hà</p>
                        <p class="text-[1.5rem] mon">Chị nhận được hàng rồi, Cảm ơn e</p>
                        ...
                        <div class="flex gap-6 mt-2">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <p class="opens text-[rgba(67,102,176,1)] text-xl">7</p>

                            </div>
                            <p class="opens text-[rgba(67,102,176,1)] text-xl">1 ngày trước</p>
                        </div>
                    </div>
                </div>

                <div class="flex gap-5 mt-8">
                    <img src="./assets/images/avt-2.webp" alt=""
                        class="w-[6.5rem] h-[6.5rem] rounded-full object-cover">
                    <div class="flex flex-col gap-2 flex-1">
                        <p class="mon text-[rgba(5,34,74,1)] font-bold">Hồng Ngọc</p>
                        <p class="text-[1.5rem] mon">Cảm ơn shop, chị nhận đc rồi, sẽ ủng hộ shop thêm</p>
                        <img src="./assets/images/images-1.jpg" alt=""
                            class="w-[24rem] h-[18rem] object-cover rounded-[2rem]">
                        <div class="flex items-center gap-0 mt-4">
                            <svg class="w-7 h-7 text-[#ffbc01]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="flex gap-5 mt-8">
                    <img src="./assets/images/avt-3.webp" alt=""
                        class="w-[6.5rem] h-[6.5rem] rounded-full object-cover">
                    <div class="flex flex-col gap-2 flex-1">
                        <p class="mon text-[rgba(5,34,74,1)] font-bold">Mạnh Hùng</p>
                        <p class="text-[1.5rem] mon">Mình nhận hàng nhanh chóng, đóng gói rất cẩn thận. </p>
                ...
                <div class="flex gap-5 mt-8">
                    <img src="./assets/images/avt-4.webp" alt=""
                        class="w-[6.5rem] h-[6.5rem] rounded-full object-cover">
                    <div class="flex flex-col gap-2 flex-1">
                        <p class="mon text-[rgba(5,34,74,1)] font-bold">Lam Quynh</p>
                        <p class="text-[1.5rem] mon">Sáng nay chị mới nhận được hàng. Đóng hộp rất đẹp. Cảm ơn shop nhé
                        </p>
                ...
                <div class="flex gap-5 mt-8">
                    <img src="./assets/images/avt-5.webp" alt=""
                        class="w-[6.5rem] h-[6.5rem] rounded-full object-cover">
                    <div class="flex flex-col gap-2 flex-1">
                        <p class="mon text-[rgba(5,34,74,1)] font-bold">Lan Anh</p>
                        <p class="text-[1.5rem] mon">Sản phẩm truyền thần chân thực</p>
                        <img src="./assets/images/images-8.jpg" alt=""
                            class="w-[24rem] h-[18rem] object-cover rounded-[2rem]">
                        <div class="flex items-center gap-0 mt-4">
                            <svg class="w-7 h-7 text-[#ffbc01]" fill="currentColor" viewBox="0 0 20 20">
                                <path
                ...
                <div class="flex gap-5 mt-8">
                    <img src="./assets/images/avt-6.webp" alt=""
                        class="w-[6.5rem] h-[6.5rem] rounded-full object-cover">
                    <div class="flex flex-col gap-2 flex-1">
                        <p class="mon text-[rgba(5,34,74,1)] font-bold">My Hà</p>
                        <p class="text-[1.5rem] mon">Hàng rất đẹp, phù hợp túi tiền. Mình sẽ ủng hộ shop lâu dài</p>
                        <img src="./assets/images/images-2.jpg" alt=""
                            class="w-[24rem] h-[18rem] object-cover rounded-[2rem]">
                        <div class="flex items-center gap-0 mt-4">
                            <svg class="w-7 h-7 text-[#ffbc01]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div
                    ...
                    <div class="pl-[16rem]">
                        <p class="text-[1.5rem] font-bold">GIÁ TRI ÂN<br><span
                                class="block text-[rgba(251,1,1,1)] font-bold text-[2.5rem] leading-none">580.000Đ</span>
                        </p>
                        <p class="line-through text-[1.7rem]">1.250.000 VNĐ</p>
                    </div>
                </div>

                <div class="text-center mt-8 max-w-fit ml-[13rem]">
                    <p class="text-[1.9rem] philo font-bold leading-[1.3]">Chất Liệu : Sa Thạch<br>Vân Gỗ Tạo Tác Thủ
                        công</p>
                </div>
        ...
        <div class="flex flex-col items-end fixed bottom-4 right-1/2 !translate-x-1/2 gap-4  w-full max-w-[42rem] pr-4">
    ...
    <footer class="bg-gradient-to-b from-[rgba(99,90,90,1)] to-[rgba(0,0,0,1)] pt-6 pb-20">
        <div class="container">
            ...
            <div class="flex items-center gap-3 mt-6">
                ...
                <p class="mon text-[1.4rem] text-white">Address: 337 Định Công, Hoàng Mai, Hà Nội</p>
            </div>
            ...
            <!-- <div class="flex items-center gap-4 mt-3">
                ...
                <p class="mon text-[1.4rem] text-white">Email: phuonglinhdecor@gmail.com</p>
            </div> -->
        </div>
    </footer>
